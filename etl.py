# This module will be used to load the song as well as log file data into Db.
...
def process_song_file(cur,filepath):
    """ 
    reads the JSON file and saves the data into
    Song and Artists table.
    Arguments : 
    cur : datbase cursor
    filepath = JSON path
    """
    ...
    df = df.fillna(0) # to replace Nan value
    # insert the song
    ...
    # if artist_data[-1] == 'nan':
    #     artist_data[-1] = 0.0
    # if artist_data[-2] == 'nan':
    #     artist_data[-2] = 0.0
    # artist_data.fillna()
